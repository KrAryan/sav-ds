...
void main() {
  group('catalog structure', () {
    ...
    test('every expected use case is registered', () {
      ...
      expect(registered['SavLabelButton'], <String>[
        'All states',
        'Playground',
        'Specs',
        'Tap target',
      ]);
      expect(registered['SavMaterial'], <String>[
        'Default & tonal',
        'Frosted glass',
        'Playground',
        'Specs',
  ...
  group('use cases render', () {
    ...
    final cases = <String, WidgetBuilder>{
      ...
      'label button / all states': buildSavLabelButtonMatrix,
      'label button / tap target': buildSavLabelButtonTapTarget,
      'label button / specs': buildSavLabelButtonSpecs,
